...
void main() {
  test('transform crop rect', () {
    ...
    final a =
        transformInsideRect(const Rect.fromLTWH(0, 0, 100, 100), imageRect, 0);
    expect(a, const Rect.fromLTWH(0, 0, 100, 100));

    final c = transformInsideRect(
        const Rect.fromLTWH(0, 0, 100, 100), imageRect, math.pi);
    ...
    final e = transformInsideRect(
        const Rect.fromLTWH(0, 0, 100, 100), imageRect, math.pi / 2);
