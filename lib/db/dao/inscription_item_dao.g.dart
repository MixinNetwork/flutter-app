...
mixin _$InscriptionItemDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  InscriptionItemDaoManager get managers => InscriptionItemDaoManager(this);
}

class InscriptionItemDaoManager {
  final _$InscriptionItemDaoMixin _db;
  InscriptionItemDaoManager(this._db);
