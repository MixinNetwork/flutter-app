...
mixin _$FloodMessageDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  FloodMessageDaoManager get managers => FloodMessageDaoManager(this);
}

class FloodMessageDaoManager {
  final _$FloodMessageDaoMixin _db;
  FloodMessageDaoManager(this._db);
