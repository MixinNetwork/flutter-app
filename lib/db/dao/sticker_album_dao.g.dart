...
mixin _$StickerAlbumDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  StickerAlbumDaoManager get managers => StickerAlbumDaoManager(this);
}

class StickerAlbumDaoManager {
  final _$StickerAlbumDaoMixin _db;
  StickerAlbumDaoManager(this._db);
