...
mixin _$InscriptionCollectionDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  InscriptionCollectionDaoManager get managers =>
      InscriptionCollectionDaoManager(this);
}

class InscriptionCollectionDaoManager {
  final _$InscriptionCollectionDaoMixin _db;
  InscriptionCollectionDaoManager(this._db);
