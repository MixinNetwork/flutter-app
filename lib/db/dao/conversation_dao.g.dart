...
mixin _$ConversationDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  Selectable<BaseUnseenConversationCountResult> _baseUnseenConversationCount(
    ...
    return customSelect(
      ...
      variables: [...generatedwhere.introducedVariables],
      readsFrom: {conversations, users, ...generatedwhere.watchedTables},
    ).map(
      (QueryRow row) => BaseUnseenConversationCountResult(
        unseenConversationCount: row.read<int>('unseen_conversation_count'),
        unseenMutedConversationCount: row.read<int>(
          'unseen_muted_conversation_count',
        ),
      ),
    );
  }
  ...
  Selectable<SearchConversationItem> _fuzzySearchConversation(
    ...
    return customSelect(
      ...
      (QueryRow row) => SearchConversationItem(
        conversationId: row.read<String>('conversationId'),
        groupIconUrl: row.readNullable<String>('groupIconUrl'),
        category: Conversations.$convertercategory.fromSql(
          row.readNullable<String>('category'),
  ...
  Selectable<SearchConversationItem> _searchConversationItemByIn(
    List<String> ids,
    SearchConversationItemByIn$order order,
  ) {
    var $arrayStartIndex = 1;
  ...
  Selectable<ConversationStorageUsage> conversationStorageUsage() {
    return customSelect(
      ...
      variables: [],
      readsFrom: {conversations, users},
    ).map(
      (QueryRow row) => ConversationStorageUsage(
  ...
  Selectable<GroupMinimal> findSameConversations(String selfId, String userId) {
    return customSelect(
      ...
      variables: [Variable<String>(selfId), Variable<String>(userId)],
      readsFrom: {conversations, participants},
    ).map(
      (QueryRow row) => GroupMinimal(
        conversationId: row.read<String>('conversationId'),
        groupIconUrl: row.readNullable<String>('groupIconUrl'),
        groupName: row.readNullable<String>('groupName'),
  ...
  Selectable<int> countConversations() {
    return customSelect(
      'SELECT COUNT(1) AS _c0 FROM conversations',
      variables: [],
      readsFrom: {conversations},
    ).map((QueryRow row) => row.read<int>('_c0'));
  }

  Future<int> _updateUnseenMessageCountAndLastMessageId(
  ...
  Selectable<bool> isBotGroup(String conversationId) {
    return customSelect(
      ...
      readsFrom: {conversations, messages, users},
    ).map((QueryRow row) => row.read<bool>('_c0'));
  }
}
typedef BaseConversationItemCount$where =
...
typedef BaseConversationItems$where =
    Expression<bool> Function(
      Conversations conversation,
      Users owner,
...
typedef BaseConversationItems$order =
    OrderBy Function(
      Conversations conversation,
      Users owner,
      Messages lastMessage,
...
typedef BaseConversationItems$limit =
    Limit Function(
      Conversations conversation,
      Users owner,
      Messages lastMessage,
...
typedef BaseConversationItemsByCircleId$where =
    Expression<bool> Function(
      Conversations conversation,
      Users owner,
      CircleConversations circleConversation,
...
typedef BaseConversationItemsByCircleId$order =
    OrderBy Function(
      Conversations conversation,
      Users owner,
      CircleConversations circleConversation,
...
typedef BaseConversationItemsByCircleId$limit =
    Limit Function(
      Conversations conversation,
      Users owner,
      CircleConversations circleConversation,
...
typedef BaseUnseenMessageCount$where =
    Expression<bool> Function(
      Conversations conversation,
      Users owner,
      CircleConversations circleConversation,
...
typedef BaseUnseenConversationCount$where =
...
typedef FuzzySearchConversation$where =
    Expression<bool> Function(
      Conversations conversation,
      Users owner,
      Messages message,
...
typedef FuzzySearchConversation$limit =
    Limit Function(
      Conversations conversation,
      Users owner,
      Messages message,
...
typedef SearchConversationItemByIn$order =
    OrderBy Function(
      Conversations conversation,
      Users owner,
      Messages message,
...
typedef FuzzySearchConversationInCircle$where =
    Expression<bool> Function(
      Conversations conversation,
      Users owner,
      Messages message,
...
typedef FuzzySearchConversationInCircle$limit =
    Limit Function(
      Conversations conversation,
      Users owner,
      Messages message,
