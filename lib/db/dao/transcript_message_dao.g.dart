...
mixin _$TranscriptMessageDaoMixin on DatabaseAccessor<MixinDatabase> {
  ...
  TranscriptMessageDaoManager get managers => TranscriptMessageDaoManager(this);
}

class TranscriptMessageDaoManager {
  final _$TranscriptMessageDaoMixin _db;
  TranscriptMessageDaoManager(this._db);
