...
class Conversations extends Table with TableInfo<Conversations, Conversation> {
  ...
  category = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints: '',
  ).withConverter<ConversationCategory?>(Conversations.$convertercategory);
  ...
  static const VerificationMeta _announcementMeta = const VerificationMeta(
    'announcement',
  );
  ...
  static const VerificationMeta _codeUrlMeta = const VerificationMeta(
    'codeUrl',
  );
  ...
  lastMessageCreatedAt = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints: '',
  ).withConverter<DateTime?>(Conversations.$converterlastMessageCreatedAtn);
  ...
  Conversation map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Conversation(
      ...
      announcement: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}announcement'],
      ),
      codeUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}code_url'],
      ),
      payType: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}pay_type'],
      ),
      createdAt: Conversations.$convertercreatedAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}created_at'],
        )!,
      ),
      pinTime: Conversations.$converterpinTimen.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}pin_time'],
        ),
      ),
      ...
      status: Conversations.$converterstatus.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
      ...
      muteUntil: Conversations.$convertermuteUntiln.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class Conversation extends DataClass implements Insertable<Conversation> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || category != null) {
      map['category'] = Variable<String>(
        Conversations.$convertercategory.toSql(category),
      );
    }
    ...
    }
    {
      map['created_at'] = Variable<int>(
        Conversations.$convertercreatedAt.toSql(createdAt),
      );
    }
    if (!nullToAbsent || pinTime != null) {
      map['pin_time'] = Variable<int>(
        Conversations.$converterpinTimen.toSql(pinTime),
      );
    }
    ...
    if (!nullToAbsent || lastMessageCreatedAt != null) {
      map['last_message_created_at'] = Variable<int>(
        Conversations.$converterlastMessageCreatedAtn.toSql(
          lastMessageCreatedAt,
        ),
      );
    }
    ...
    }
    {
      map['status'] = Variable<int>(
        Conversations.$converterstatus.toSql(status),
      );
    }
    ...
    if (!nullToAbsent || muteUntil != null) {
      map['mute_until'] = Variable<int>(
        Conversations.$convertermuteUntiln.toSql(muteUntil),
      );
    }
  ...
  factory Conversation.fromJson(
    ...
    return Conversation(
      ...
      unseenMessageCount: serializer.fromJson<int?>(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'last_message_created_at': serializer.toJson<DateTime?>(
        lastMessageCreatedAt,
      ),
  ...
  Conversation copyWith({
    ...
    announcement: announcement.present ? announcement.value : this.announcement,
...
class ConversationsCompanion extends UpdateCompanion<Conversation> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pinTime.present) {
      map['pin_time'] = Variable<int>(
        Conversations.$converterpinTimen.toSql(pinTime.value),
      );
    }
    ...
    if (status.present) {
      map['status'] = Variable<int>(
        Conversations.$converterstatus.toSql(status.value),
      );
    }
    if (draft.present) {
...
class Messages extends Table with TableInfo<Messages, Message> {
  ...
  static const VerificationMeta _thumbImageMeta = const VerificationMeta(
    'thumbImage',
  );
  ...
  static const VerificationMeta _mediaDigestMeta = const VerificationMeta(
    'mediaDigest',
  );
  ...
  static const VerificationMeta _hyperlinkMeta = const VerificationMeta(
    'hyperlink',
  );
  ...
  static const VerificationMeta _sharedUserIdMeta = const VerificationMeta(
    'sharedUserId',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('thumb_image')) {
      context.handle(
        _thumbImageMeta,
        thumbImage.isAcceptableOrUnknown(data['thumb_image']!, _thumbImageMeta),
      );
    }
  ...
  Message map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Message(
      ...
      thumbImage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}thumb_image'],
      ),
      mediaKey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}media_key'],
      ),
      mediaDigest: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}media_digest'],
      ),
      ...
      status: Messages.$converterstatus.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}status'],
        )!,
      ...
      sharedUserId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}shared_user_id'],
      ),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || mediaStatus != null) {
      map['media_status'] = Variable<String>(
        Messages.$convertermediaStatus.toSql(mediaStatus),
      );
    }
    {
    ...
    {
      map['created_at'] = Variable<int>(
        Messages.$convertercreatedAt.toSql(createdAt),
      );
    }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (status.present) {
      map['status'] = Variable<String>(
        Messages.$converterstatus.toSql(status.value),
      );
    }
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Messages.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    if (action.present) {
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      membership: Users.$convertermembership.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}membership'],
        ),
      ),
      ...
      createdAt: Users.$convertercreatedAtn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}created_at'],
        ),
      ),
      muteUntil: Users.$convertermuteUntiln.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}mute_until'],
        ),
      ...
      isScam: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}is_scam'],
      ),
      codeUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}code_url'],
      ),
      codeId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}code_id'],
      ),
...
class User extends DataClass implements Insertable<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || relationship != null) {
      map['relationship'] = Variable<String>(
        Users.$converterrelationship.toSql(relationship),
      );
    }
    if (!nullToAbsent || membership != null) {
      map['membership'] = Variable<String>(
        Users.$convertermembership.toSql(membership),
      );
    }
    ...
    if (!nullToAbsent || createdAt != null) {
      map['created_at'] = Variable<int>(
        Users.$convertercreatedAtn.toSql(createdAt),
      );
    }
    if (!nullToAbsent || muteUntil != null) {
      map['mute_until'] = Variable<int>(
        Users.$convertermuteUntiln.toSql(muteUntil),
      );
    }
  ...
  factory User.fromJson(
    ...
    return User(
      ...
      relationship: serializer.fromJson<UserRelationship?>(
        json['relationship'],
      ),
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (membership.present) {
      map['membership'] = Variable<String>(
        Users.$convertermembership.toSql(membership.value),
      );
    }
    if (fullName.present) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Users.$convertercreatedAtn.toSql(createdAt.value),
      );
    }
    if (muteUntil.present) {
      map['mute_until'] = Variable<int>(
        Users.$convertermuteUntiln.toSql(muteUntil.value),
      );
    }
    if (hasPin.present) {
...
class Snapshot extends DataClass implements Insertable<Snapshot> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        Snapshots.$convertercreatedAt.toSql(createdAt),
      );
    }
...
class SnapshotsCompanion extends UpdateCompanion<Snapshot> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Snapshots.$convertercreatedAt.toSql(createdAt.value),
      );
    }
...
class SafeSnapshots extends Table with TableInfo<SafeSnapshots, SafeSnapshot> {
  ...
  static const VerificationMeta _inscriptionHashMeta = const VerificationMeta(
    'inscriptionHash',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SafeSnapshot> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  SafeSnapshot map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SafeSnapshot(
      ...
      withdrawal: SafeSnapshots.$converterwithdrawal.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}withdrawal'],
        ),
      ),
      deposit: SafeSnapshots.$converterdeposit.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || deposit != null) {
      map['deposit'] = Variable<String>(
        SafeSnapshots.$converterdeposit.toSql(deposit),
      );
    }
...
class Assets extends Table with TableInfo<Assets, Asset> {
  ...
  static const VerificationMeta _priceBtcMeta = const VerificationMeta(
    'priceBtc',
  );
  ...
  static const VerificationMeta _changeUsdMeta = const VerificationMeta(
    'changeUsd',
  );
  ...
  static const VerificationMeta _changeBtcMeta = const VerificationMeta(
    'changeBtc',
  );
  ...
  static const VerificationMeta _reserveMeta = const VerificationMeta(
    'reserve',
  );
...
class Tokens extends Table with TableInfo<Tokens, Token> {
  ...
  static const VerificationMeta _kernelAssetIdMeta = const VerificationMeta(
    'kernelAssetId',
  );
  ...
  static const VerificationMeta _collectionHashMeta = const VerificationMeta(
    'collectionHash',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('dust')) {
      context.handle(
        _dustMeta,
        dust.isAcceptableOrUnknown(data['dust']!, _dustMeta),
      );
    } else if (isInserting) {
...
class Stickers extends Table with TableInfo<Stickers, Sticker> {
  ...
  static const VerificationMeta _assetUrlMeta = const VerificationMeta(
    'assetUrl',
  );
  ...
  static const VerificationMeta _assetWidthMeta = const VerificationMeta(
    'assetWidth',
  );
  ...
  static const VerificationMeta _assetHeightMeta = const VerificationMeta(
    'assetHeight',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('asset_width')) {
      context.handle(
        _assetWidthMeta,
        assetWidth.isAcceptableOrUnknown(data['asset_width']!, _assetWidthMeta),
      );
    } else if (isInserting) {
  ...
  Sticker map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Sticker(
      ...
      lastUseAt: Stickers.$converterlastUseAtn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}last_use_at'],
        ),
      ),
    );
  }
...
class Sticker extends DataClass implements Insertable<Sticker> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        Stickers.$convertercreatedAt.toSql(createdAt),
      );
    }
    if (!nullToAbsent || lastUseAt != null) {
      map['last_use_at'] = Variable<int>(
        Stickers.$converterlastUseAtn.toSql(lastUseAt),
      );
    }
    return map;
  }
...
class StickersCompanion extends UpdateCompanion<Sticker> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Stickers.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    if (lastUseAt.present) {
      map['last_use_at'] = Variable<int>(
        Stickers.$converterlastUseAtn.toSql(lastUseAt.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class Hyperlinks extends Table with TableInfo<Hyperlinks, Hyperlink> {
  ...
  static const VerificationMeta _siteTitleMeta = const VerificationMeta(
    'siteTitle',
  );
  ...
  static const VerificationMeta _siteDescriptionMeta = const VerificationMeta(
    'siteDescription',
  );
  ...
  static const VerificationMeta _siteImageMeta = const VerificationMeta(
    'siteImage',
  );
  ...
  Hyperlink map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Hyperlink(
      ...
      siteImage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}site_image'],
      ),
    );
  }
...
class MessageMentions extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<MessageMention> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class MessageMention extends DataClass implements Insertable<MessageMention> {
  ...
  factory MessageMention.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class PinMessages extends Table with TableInfo<PinMessages, PinMessage> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PinMessage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class PinMessage extends DataClass implements Insertable<PinMessage> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        PinMessages.$convertercreatedAt.toSql(createdAt),
      );
    }
    return map;
  }
...
class PinMessagesCompanion extends UpdateCompanion<PinMessage> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        PinMessages.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class ExpiredMessages extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ExpiredMessage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class ExpiredMessage extends DataClass implements Insertable<ExpiredMessage> {
  ...
  factory ExpiredMessage.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['label'] = Variable<String>(label);
    {
      map['updated_at'] = Variable<int>(
        Addresses.$converterupdatedAt.toSql(updatedAt),
      );
    }
    map['reserve'] = Variable<String>(reserve);
...
class AddressesCompanion extends UpdateCompanion<Address> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (updatedAt.present) {
      map['updated_at'] = Variable<int>(
        Addresses.$converterupdatedAt.toSql(updatedAt.value),
      );
    }
    if (reserve.present) {
      map['reserve'] = Variable<String>(reserve.value);
...
class Apps extends Table with TableInfo<Apps, App> {
  ...
  static const VerificationMeta _appNumberMeta = const VerificationMeta(
    'appNumber',
  );
  ...
  static const VerificationMeta _homeUriMeta = const VerificationMeta(
    'homeUri',
  );
  ...
  static const VerificationMeta _appSecretMeta = const VerificationMeta(
    'appSecret',
  );
  ...
  static const VerificationMeta _resourcePatternsMeta = const VerificationMeta(
    'resourcePatterns',
  );
  ...
  App map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return App(
      ...
      updatedAt: Apps.$converterupdatedAtn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}updated_at'],
        ),
...
class App extends DataClass implements Insertable<App> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || updatedAt != null) {
      map['updated_at'] = Variable<int>(
        Apps.$converterupdatedAtn.toSql(updatedAt),
      );
    }
    return map;
  }
...
class AppsCompanion extends UpdateCompanion<App> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (updatedAt.present) {
      map['updated_at'] = Variable<int>(
        Apps.$converterupdatedAtn.toSql(updatedAt.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class CircleConversations extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CircleConversation> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  CircleConversation map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CircleConversation(
      ...
      pinTime: CircleConversations.$converterpinTimen.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}pin_time'],
        ),
...
class CircleConversation extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || pinTime != null) {
      map['pin_time'] = Variable<int>(
        CircleConversations.$converterpinTimen.toSql(pinTime),
      );
    }
    return map;
  }
  ...
  factory CircleConversation.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class Circles extends Table with TableInfo<Circles, Circle> {
  ...
  Circle map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Circle(
      ...
      orderedAt: Circles.$converterorderedAtn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class Circle extends DataClass implements Insertable<Circle> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        Circles.$convertercreatedAt.toSql(createdAt),
      );
    }
    if (!nullToAbsent || orderedAt != null) {
      map['ordered_at'] = Variable<int>(
        Circles.$converterorderedAtn.toSql(orderedAt),
      );
    }
    return map;
  }
...
class CirclesCompanion extends UpdateCompanion<Circle> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Circles.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    if (orderedAt.present) {
      map['ordered_at'] = Variable<int>(
        Circles.$converterorderedAtn.toSql(orderedAt.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class FloodMessages extends Table with TableInfo<FloodMessages, FloodMessage> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FloodMessage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class FloodMessage extends DataClass implements Insertable<FloodMessage> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        FloodMessages.$convertercreatedAt.toSql(createdAt),
      );
    }
    return map;
  }
...
class Jobs extends Table with TableInfo<Jobs, Job> {
  ...
  static const VerificationMeta _blazeMessageMeta = const VerificationMeta(
    'blazeMessage',
  );
  ...
  static const VerificationMeta _resendMessageIdMeta = const VerificationMeta(
    'resendMessageId',
  );
  ...
  Job map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Job(
      ...
      blazeMessage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}blaze_message'],
      ),
      conversationId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}conversation_id'],
...
class Job extends DataClass implements Insertable<Job> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        Jobs.$convertercreatedAt.toSql(createdAt),
      );
    }
...
class JobsCompanion extends UpdateCompanion<Job> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (createdAt.present) {
      map['created_at'] = Variable<int>(
        Jobs.$convertercreatedAt.toSql(createdAt.value),
      );
    }
    if (orderId.present) {
...
class MessagesHistoryData extends DataClass
  ...
  MessagesHistoryCompanion toCompanion(bool nullToAbsent) {
    return MessagesHistoryCompanion(messageId: Value(messageId));
  }

  factory MessagesHistoryData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  MessagesHistoryData copyWith({String? messageId}) =>
      MessagesHistoryData(messageId: messageId ?? this.messageId);
...
class Offset extends DataClass implements Insertable<Offset> {
  ...
  OffsetsCompanion toCompanion(bool nullToAbsent) {
    return OffsetsCompanion(key: Value(key), timestamp: Value(timestamp));
  }
  ...
  Offset copyWith({String? key, String? timestamp}) =>
      Offset(key: key ?? this.key, timestamp: timestamp ?? this.timestamp);
...
class ParticipantSession extends Table
  ...
  static const VerificationMeta _sentToServerMeta = const VerificationMeta(
    'sentToServer',
  );
...
class ParticipantSessionData extends DataClass
  ...
  factory ParticipantSessionData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ParticipantSessionData copyWith({
    ...
    sentToServer: sentToServer.present ? sentToServer.value : this.sentToServer,
    createdAt: createdAt.present ? createdAt.value : this.createdAt,
...
class ResendSessionMessage extends DataClass
  ...
  factory ResendSessionMessage.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class SentSessionSenderKeys extends Table
  ...
  static const VerificationMeta _senderKeyIdMeta = const VerificationMeta(
    'senderKeyId',
  );
...
class SentSessionSenderKey extends DataClass
  ...
  factory SentSessionSenderKey.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class StickerAlbums extends Table with TableInfo<StickerAlbums, StickerAlbum> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<StickerAlbum> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  StickerAlbum map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return StickerAlbum(
      ...
      updateAt: StickerAlbums.$converterupdateAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class StickerAlbum extends DataClass implements Insertable<StickerAlbum> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        StickerAlbums.$convertercreatedAt.toSql(createdAt),
      );
    }
    {
      map['update_at'] = Variable<int>(
        StickerAlbums.$converterupdateAt.toSql(updateAt),
      );
    }
...
class StickerAlbumsCompanion extends UpdateCompanion<StickerAlbum> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (updateAt.present) {
      map['update_at'] = Variable<int>(
        StickerAlbums.$converterupdateAt.toSql(updateAt.value),
      );
    }
    if (orderedAt.present) {
...
class StickerRelationship extends DataClass
  ...
  factory StickerRelationship.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class TranscriptMessages extends Table
  ...
  static const VerificationMeta _userFullNameMeta = const VerificationMeta(
    'userFullName',
  );
  ...
  mediaStatus = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints: '',
  ).withConverter<MediaStatus?>(TranscriptMessages.$convertermediaStatus);
  static const VerificationMeta _mediaWaveformMeta = const VerificationMeta(
    'mediaWaveform',
  );
  late final GeneratedColumn<String> mediaWaveform = GeneratedColumn<String>(
  ...
  late final GeneratedColumnWithTypeConverter<DateTime?, int> mediaCreatedAt =
      GeneratedColumn<int>(
        ...
        requiredDuringInsert: false,
        $customConstraints: '',
      ).withConverter<DateTime?>(TranscriptMessages.$convertermediaCreatedAtn);
  static const VerificationMeta _stickerIdMeta = const VerificationMeta(
    'stickerId',
  );
  late final GeneratedColumn<String> stickerId = GeneratedColumn<String>(
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<TranscriptMessage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  TranscriptMessage map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TranscriptMessage(
      ...
      userFullName: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class TranscriptMessage extends DataClass
  ...
  TranscriptMessage copyWith({
    ...
    messageId: messageId ?? this.messageId,
    userId: userId.present ? userId.value : this.userId,
    userFullName: userFullName.present ? userFullName.value : this.userFullName,
    category: category ?? this.category,
    createdAt: createdAt ?? this.createdAt,
    content: content.present ? content.value : this.content,
    mediaUrl: mediaUrl.present ? mediaUrl.value : this.mediaUrl,
...
class TranscriptMessagesCompanion extends UpdateCompanion<TranscriptMessage> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (mediaCreatedAt.present) {
      map['media_created_at'] = Variable<int>(
        TranscriptMessages.$convertermediaCreatedAtn.toSql(
          mediaCreatedAt.value,
        ),
      );
    }
...
class Fiat extends DataClass implements Insertable<Fiat> {
  ...
  FiatsCompanion toCompanion(bool nullToAbsent) {
    return FiatsCompanion(code: Value(code), rate: Value(rate));
  }

  factory Fiat.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  Fiat copyWith({String? code, double? rate}) =>
      Fiat(code: code ?? this.code, rate: rate ?? this.rate);
...
class FavoriteApps extends Table with TableInfo<FavoriteApps, FavoriteApp> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FavoriteApp> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class FavoriteApp extends DataClass implements Insertable<FavoriteApp> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        FavoriteApps.$convertercreatedAt.toSql(createdAt),
      );
    }
    return map;
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (group.present) {
      map['group'] = Variable<String>(
        Properties.$convertergroup.toSql(group.value),
      );
    }
    if (value.present) {
...
class InscriptionCollection extends DataClass
  ...
  factory InscriptionCollection.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class InscriptionItems extends Table
  ...
  static const VerificationMeta _occupiedByMeta = const VerificationMeta(
    'occupiedBy',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<InscriptionItem> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('occupied_by')) {
      context.handle(
        _occupiedByMeta,
        occupiedBy.isAcceptableOrUnknown(data['occupied_by']!, _occupiedByMeta),
      );
    }
  ...
  InscriptionItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return InscriptionItem(
      ...
      createdAt: InscriptionItems.$convertercreatedAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}created_at'],
        )!,
      ),
      updatedAt: InscriptionItems.$converterupdatedAt.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}updated_at'],
        )!,
...
class InscriptionItem extends DataClass implements Insertable<InscriptionItem> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['created_at'] = Variable<int>(
        InscriptionItems.$convertercreatedAt.toSql(createdAt),
      );
    }
    {
      map['updated_at'] = Variable<int>(
        InscriptionItems.$converterupdatedAt.toSql(updatedAt),
      );
    }
    return map;
  }
  ...
  factory InscriptionItem.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$MixinDatabase extends GeneratedDatabase {
  ...
  late final CircleConversations circleConversations = CircleConversations(
    this,
  );
  ...
  late final StickerRelationships stickerRelationships = StickerRelationships(
    this,
  );
  ...
  late final Index indexJobsAction = Index(
    'index_jobs_action',
  ...
  late final FloodMessageDao floodMessageDao = FloodMessageDao(
    this as MixinDatabase,
  );
  ...
  late final MessageMentionDao messageMentionDao = MessageMentionDao(
    this as MixinDatabase,
  );
  late final MessageDao messageDao = MessageDao(this as MixinDatabase);
  late final MessageHistoryDao messageHistoryDao = MessageHistoryDao(
    this as MixinDatabase,
  );
  ...
  late final StickerAlbumDao stickerAlbumDao = StickerAlbumDao(
    this as MixinDatabase,
  );
  ...
  late final FavoriteAppDao favoriteAppDao = FavoriteAppDao(
    this as MixinDatabase,
  );
  late final ExpiredMessageDao expiredMessageDao = ExpiredMessageDao(
    this as MixinDatabase,
  );
  ...
  late final TranscriptMessageDao transcriptMessageDao = TranscriptMessageDao(
    this as MixinDatabase,
  );
  late final SafeSnapshotDao safeSnapshotDao = SafeSnapshotDao(
    this as MixinDatabase,
  );
  late final TokenDao tokenDao = TokenDao(this as MixinDatabase);
  late final InscriptionItemDao inscriptionItemDao = InscriptionItemDao(
    this as MixinDatabase,
  );
  ...
  Selectable<MessageItem> baseMessageItems(
    BaseMessageItems$where where,
    BaseMessageItems$order order,
    BaseMessageItems$limit limit,
  ) {
    ...
    return customSelect(
      ...
      (QueryRow row) => MessageItem(
        ...
        sharedUserMembership: Users.$convertermembership.fromSql(
          row.readNullable<String>('sharedUserMembership'),
        ),
        conversationOwnerId: row.readNullable<String>('conversationOwnerId'),
        conversionCategory: Conversations.$convertercategory.fromSql(
          row.readNullable<String>('conversionCategory'),
        ),
  ...
  Selectable<MessageItem> basePinMessageItems(
    String conversationId,
    BasePinMessageItems$order order,
    BasePinMessageItems$limit limit,
  ) {
  ...
  Selectable<SearchItem> fuzzySearchUserItem(
    String query,
    FuzzySearchUserItem$where where,
    FuzzySearchUserItem$limit limit,
  ) {
    var $arrayStartIndex = 2;
    final generatedwhere = $write(
      where(this.users),
  ...
  Selectable<SearchItem> fuzzySearchConversationItem(
    ...
    $arrayStartIndex += generatedlimit.amountOfVariables;
    return customSelect(
      'WITH query_parts AS (SELECT TRIM(?1) AS full_query, CASE WHEN INSTR(TRIM(?1), \' \') = 0 THEN TRIM(?1) ELSE TRIM(SUBSTR(TRIM(?1), 1, INSTR(TRIM(?1), \' \') - 1)) END AS keyword1, CASE WHEN INSTR(TRIM(?1), \' \') = 0 THEN \'\' ELSE TRIM(SUBSTR(TRIM(?1), INSTR(TRIM(?1), \' \') + 1)) END AS remaining1), split_query AS (SELECT full_query, keyword1, CASE WHEN INSTR(remaining1, \' \') = 0 THEN remaining1 ELSE TRIM(SUBSTR(remaining1, 1, INSTR(remaining1, \' \') - 1)) END AS keyword2, CASE WHEN INSTR(remaining1, \' \') = 0 THEN \'\' ELSE TRIM(SUBSTR(remaining1, INSTR(remaining1, \' \') + 1)) END AS remaining2 FROM query_parts), final_keywords AS (SELECT full_query, keyword1, keyword2, CASE WHEN INSTR(remaining2, \' \') = 0 THEN remaining2 ELSE TRIM(SUBSTR(remaining2, 1, INSTR(remaining2, \' \') - 1)) END AS keyword3 FROM split_query) SELECT CASE WHEN conversation.category = \'GROUP\' THEN \'GROUP\' ELSE \'CONTACT\' END AS type, conversation.conversation_id AS id, CASE WHEN conversation.category = \'GROUP\' THEN conversation.name ELSE owner.full_name END AS name, CASE WHEN conversation.category = \'GROUP\' THEN conversation.icon_url ELSE owner.avatar_url END AS avatar_url, COALESCE(owner.is_verified, FALSE) AS is_verified, owner.app_id AS app_id, CASE WHEN conversation.category = \'CONTACT\' THEN owner.membership ELSE NULL END AS membership, CASE WHEN LENGTH(kw.full_query) = 0 THEN 0.0 WHEN LENGTH(kw.keyword2) = 0 THEN CASE WHEN name = kw.full_query COLLATE NOCASE THEN 1.0 + 1.0 / LENGTH(name) WHEN name LIKE kw.full_query || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 0.6 + 1.0 / LENGTH(name) WHEN name LIKE \'%\' || kw.full_query || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 0.3 + 1.0 / LENGTH(name) ELSE 0.0 END WHEN((LENGTH(kw.keyword1) > 0 AND name LIKE \'%\' || kw.keyword1 || \'%\' ESCAPE \'\\\' COLLATE NOCASE)OR(LENGTH(kw.keyword2) > 0 AND name LIKE \'%\' || kw.keyword2 || \'%\' ESCAPE \'\\\' COLLATE NOCASE)OR(LENGTH(kw.keyword3) > 0 AND name LIKE \'%\' || kw.keyword3 || \'%\' ESCAPE \'\\\' COLLATE NOCASE))THEN(CASE WHEN LENGTH(kw.keyword1) > 0 AND name LIKE \'%\' || kw.keyword1 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 1 ELSE 0 END + CASE WHEN LENGTH(kw.keyword2) > 0 AND name LIKE \'%\' || kw.keyword2 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 1 ELSE 0 END + CASE WHEN LENGTH(kw.keyword3) > 0 AND name LIKE \'%\' || kw.keyword3 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 1 ELSE 0 END)* 0.1 + CASE WHEN LENGTH(kw.keyword1) > 0 AND LENGTH(kw.keyword2) > 0 AND name LIKE \'%\' || kw.keyword1 || \'%\' || kw.keyword2 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 0.2 ELSE 0.0 END + CASE WHEN LENGTH(kw.keyword1) > 0 AND LENGTH(kw.keyword2) > 0 AND name LIKE \'%\' || kw.keyword1 || \' \' || kw.keyword2 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 0.15 ELSE 0.0 END + CASE WHEN LENGTH(kw.keyword1) > 0 AND name LIKE kw.keyword1 || \'%\' ESCAPE \'\\\' COLLATE NOCASE THEN 0.1 ELSE 0.0 END + 1.0 / LENGTH(name) ELSE 0.0 END AS match_score FROM conversations AS conversation INNER JOIN users AS owner ON owner.user_id = conversation.owner_id CROSS JOIN final_keywords AS kw WHERE ${generatedwhere.sql} ORDER BY match_score DESC, conversation.pin_time DESC ${generatedlimit.sql}',
      variables: [
        Variable<String>(query),
        ...generatedwhere.introducedVariables,
        ...generatedlimit.introducedVariables,
...
typedef $SnapshotsUpdateCompanionBuilder =
    SnapshotsCompanion Function({
      Value<String> snapshotId,
      Value<String?> traceId,
      Value<String> type,
...
typedef $SnapshotsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Snapshots,
      Snapshot,
      ...
      PrefetchHooks Function()
    >;
typedef $SafeSnapshotsCreateCompanionBuilder =
    SafeSnapshotsCompanion Function({
      required String snapshotId,
      required String type,
      required String assetId,
      required String amount,
...
typedef $SafeSnapshotsUpdateCompanionBuilder =
    SafeSnapshotsCompanion Function({
      Value<String> snapshotId,
      Value<String> type,
      Value<String> assetId,
...
class $SafeSnapshotsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          SafeSnapshots,
...
typedef $SafeSnapshotsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      SafeSnapshots,
      SafeSnapshot,
...
typedef $AssetsProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $TokensCreateCompanionBuilder =
...
typedef $TokensProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Tokens,
      Token,
      ...
      PrefetchHooks Function()
    >;
typedef $ChainsCreateCompanionBuilder =
    ChainsCompanion Function({
      required String chainId,
      required String name,
      required String symbol,
      required String iconUrl,
...
typedef $ChainsUpdateCompanionBuilder =
    ChainsCompanion Function({
      Value<String> chainId,
      Value<String> name,
      Value<String> symbol,
...
typedef $ChainsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Chains,
      Chain,
      ...
      PrefetchHooks Function()
    >;
typedef $StickersCreateCompanionBuilder =
...
typedef $StickersUpdateCompanionBuilder =
    StickersCompanion Function({
      Value<String> stickerId,
      Value<String?> albumId,
      Value<String> name,
...
typedef $StickersProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Stickers,
      Sticker,
      ...
      PrefetchHooks Function()
    >;
typedef $HyperlinksCreateCompanionBuilder =
    HyperlinksCompanion Function({
      required String hyperlink,
      required String siteName,
      required String siteTitle,
      Value<String?> siteDescription,
...
typedef $HyperlinksUpdateCompanionBuilder =
    HyperlinksCompanion Function({
      Value<String> hyperlink,
      Value<String> siteName,
      Value<String> siteTitle,
...
typedef $HyperlinksProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Hyperlinks,
      Hyperlink,
      ...
      PrefetchHooks Function()
    >;
typedef $MessageMentionsCreateCompanionBuilder =
    MessageMentionsCompanion Function({
      required String messageId,
      required String conversationId,
      Value<bool?> hasRead,
      Value<int> rowid,
    });
typedef $MessageMentionsUpdateCompanionBuilder =
    MessageMentionsCompanion Function({
      Value<String> messageId,
      Value<String> conversationId,
      Value<bool?> hasRead,
...
class $MessageMentionsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          MessageMentions,
...
typedef $MessageMentionsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      MessageMentions,
      MessageMention,
      ...
      PrefetchHooks Function()
    >;
typedef $PinMessagesCreateCompanionBuilder =
...
typedef $PinMessagesUpdateCompanionBuilder =
    PinMessagesCompanion Function({
      Value<String> messageId,
      Value<String> conversationId,
      Value<DateTime> createdAt,
...
class $PinMessagesTableManager
    extends
        RootTableManager<
          ...
          (
            PinMessage,
            BaseReferences<_$MixinDatabase, PinMessages, PinMessage>,
          ),
          PinMessage,
          PrefetchHooks Function()
        > {
...
typedef $PinMessagesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      PinMessages,
      PinMessage,
      ...
      PrefetchHooks Function()
    >;
typedef $ExpiredMessagesCreateCompanionBuilder =
    ExpiredMessagesCompanion Function({
      required String messageId,
      required int expireIn,
      Value<int?> expireAt,
      Value<int> rowid,
    });
typedef $ExpiredMessagesUpdateCompanionBuilder =
    ExpiredMessagesCompanion Function({
      Value<String> messageId,
      Value<int> expireIn,
      Value<int?> expireAt,
...
class $ExpiredMessagesTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          ExpiredMessages,
...
typedef $ExpiredMessagesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      ExpiredMessages,
      ExpiredMessage,
      ...
      PrefetchHooks Function()
    >;
typedef $AddressesCreateCompanionBuilder =
...
typedef $AddressesUpdateCompanionBuilder =
    AddressesCompanion Function({
      Value<String> addressId,
      Value<String> type,
      Value<String> assetId,
...
typedef $AddressesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Addresses,
      Address,
      ...
      PrefetchHooks Function()
    >;
typedef $AppsCreateCompanionBuilder =
...
typedef $AppsUpdateCompanionBuilder =
    AppsCompanion Function({
      Value<String> appId,
      Value<String> appNumber,
      Value<String> homeUri,
...
typedef $AppsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Apps,
      App,
...
class $CircleConversationsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          CircleConversations,
...
typedef $CircleConversationsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      CircleConversations,
      CircleConversation,
      ...
      PrefetchHooks Function()
    >;
typedef $CirclesCreateCompanionBuilder =
...
typedef $CirclesUpdateCompanionBuilder =
    CirclesCompanion Function({
      Value<String> circleId,
      Value<String> name,
      Value<DateTime> createdAt,
...
typedef $CirclesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Circles,
      Circle,
      ...
      PrefetchHooks Function()
    >;
typedef $FloodMessagesCreateCompanionBuilder =
    FloodMessagesCompanion Function({
      required String messageId,
      required String data,
      required DateTime createdAt,
      Value<int> rowid,
    });
typedef $FloodMessagesUpdateCompanionBuilder =
    FloodMessagesCompanion Function({
      Value<String> messageId,
      Value<String> data,
      Value<DateTime> createdAt,
...
class $FloodMessagesTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          FloodMessages,
...
typedef $FloodMessagesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      FloodMessages,
      FloodMessage,
      ...
      PrefetchHooks Function()
    >;
typedef $JobsCreateCompanionBuilder =
...
typedef $JobsUpdateCompanionBuilder =
    JobsCompanion Function({
      Value<String> jobId,
      Value<String> action,
      Value<DateTime> createdAt,
...
typedef $JobsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Jobs,
      Job,
      ...
      PrefetchHooks Function()
    >;
typedef $MessagesHistoryCreateCompanionBuilder =
    MessagesHistoryCompanion Function({
      required String messageId,
      Value<int> rowid,
    });
typedef $MessagesHistoryUpdateCompanionBuilder =
    MessagesHistoryCompanion Function({
      Value<String> messageId,
      Value<int> rowid,
    });
...
class $MessagesHistoryTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          MessagesHistory,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
                  ...
                  MessagesHistoryCompanion(messageId: messageId, rowid: rowid),
          createCompanionCallback:
              ({
                required String messageId,
                Value<int> rowid = const Value.absent(),
...
typedef $MessagesHistoryProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      MessagesHistory,
      MessagesHistoryData,
      ...
      PrefetchHooks Function()
    >;
typedef $OffsetsCreateCompanionBuilder =
    OffsetsCompanion Function({
      required String key,
      required String timestamp,
      Value<int> rowid,
    });
typedef $OffsetsUpdateCompanionBuilder =
    OffsetsCompanion Function({
      Value<String> key,
      Value<String> timestamp,
      Value<int> rowid,
...
typedef $OffsetsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Offsets,
      Offset,
      ...
      PrefetchHooks Function()
    >;
typedef $ParticipantSessionCreateCompanionBuilder =
    ParticipantSessionCompanion Function({
      required String conversationId,
      required String userId,
      required String sessionId,
      Value<int?> sentToServer,
...
typedef $ParticipantSessionUpdateCompanionBuilder =
    ParticipantSessionCompanion Function({
      Value<String> conversationId,
      Value<String> userId,
      Value<String> sessionId,
...
class $ParticipantSessionTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          ParticipantSession,
...
typedef $ParticipantSessionProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      ParticipantSession,
      ParticipantSessionData,
...
class $ResendSessionMessagesTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          ResendSessionMessages,
...
typedef $ResendSessionMessagesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      ResendSessionMessages,
      ResendSessionMessage,
...
class $SentSessionSenderKeysTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          SentSessionSenderKeys,
...
typedef $SentSessionSenderKeysProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      SentSessionSenderKeys,
      SentSessionSenderKey,
      ...
      PrefetchHooks Function()
    >;
typedef $StickerAlbumsCreateCompanionBuilder =
    StickerAlbumsCompanion Function({
      required String albumId,
      required String name,
      required String iconUrl,
      required DateTime createdAt,
...
typedef $StickerAlbumsUpdateCompanionBuilder =
    StickerAlbumsCompanion Function({
      Value<String> albumId,
      Value<String> name,
      Value<String> iconUrl,
...
class $StickerAlbumsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          StickerAlbums,
...
typedef $StickerAlbumsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      StickerAlbums,
      StickerAlbum,
...
class $StickerRelationshipsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          StickerRelationships,
...
typedef $StickerRelationshipsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      StickerRelationships,
      StickerRelationship,
      ...
      PrefetchHooks Function()
    >;
typedef $TranscriptMessagesCreateCompanionBuilder =
...
typedef $TranscriptMessagesUpdateCompanionBuilder =
    TranscriptMessagesCompanion Function({
      Value<String> transcriptId,
      Value<String> messageId,
      Value<String?> userId,
...
class $TranscriptMessagesTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          TranscriptMessages,
...
typedef $TranscriptMessagesProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      TranscriptMessages,
      TranscriptMessage,
      ...
      PrefetchHooks Function()
    >;
typedef $FiatsCreateCompanionBuilder =
    FiatsCompanion Function({
      required String code,
      required double rate,
      Value<int> rowid,
    });
typedef $FiatsUpdateCompanionBuilder =
    FiatsCompanion Function({
      Value<String> code,
      Value<double> rate,
      Value<int> rowid,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
              }) => FiatsCompanion(code: code, rate: rate, rowid: rowid),
          createCompanionCallback:
              ({
                required String code,
                required double rate,
...
typedef $FiatsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      Fiats,
      Fiat,
      ...
      PrefetchHooks Function()
    >;
typedef $FavoriteAppsCreateCompanionBuilder =
    FavoriteAppsCompanion Function({
      required String appId,
      required String userId,
      required DateTime createdAt,
      Value<int> rowid,
    });
typedef $FavoriteAppsUpdateCompanionBuilder =
    FavoriteAppsCompanion Function({
      Value<String> appId,
      Value<String> userId,
      Value<DateTime> createdAt,
...
class $FavoriteAppsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          FavoriteApps,
          ...
          (
            FavoriteApp,
            BaseReferences<_$MixinDatabase, FavoriteApps, FavoriteApp>,
          ),
          FavoriteApp,
          PrefetchHooks Function()
        > {
...
typedef $FavoriteAppsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      FavoriteApps,
      FavoriteApp,
...
class $InscriptionCollectionsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          InscriptionCollections,
...
typedef $InscriptionCollectionsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      InscriptionCollections,
      InscriptionCollection,
      ...
      PrefetchHooks Function()
    >;
typedef $InscriptionItemsCreateCompanionBuilder =
    InscriptionItemsCompanion Function({
      required String inscriptionHash,
      required String collectionHash,
      required int sequence,
      required String contentType,
...
typedef $InscriptionItemsUpdateCompanionBuilder =
    InscriptionItemsCompanion Function({
      Value<String> inscriptionHash,
      Value<String> collectionHash,
      Value<int> sequence,
...
class $InscriptionItemsTableManager
    extends
        RootTableManager<
          _$MixinDatabase,
          InscriptionItems,
...
typedef $InscriptionItemsProcessedTableManager =
    ProcessedTableManager<
      _$MixinDatabase,
      InscriptionItems,
      InscriptionItem,
...
typedef BaseMessageItems$where =
...
typedef BaseMessageItems$order =
    OrderBy Function(
      Messages message,
      Users sender,
      Users participant,
...
typedef BaseMessageItems$limit =
    Limit Function(
      Messages message,
      Users sender,
      Users participant,
...
typedef BasePinMessageItems$order =
    OrderBy Function(
      PinMessages pinMessage,
      Messages message,
      Users sender,
...
typedef BasePinMessageItems$limit =
    Limit Function(
      PinMessages pinMessage,
      Messages message,
      Users sender,
...
typedef FuzzySearchConversationItem$where =
    Expression<bool> Function(Conversations conversation, Users owner);
typedef FuzzySearchConversationItem$limit =
    Limit Function(Conversations conversation, Users owner);
