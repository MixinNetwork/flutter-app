...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(arg0) => "等待${arg0}上线后建立加密会话。";

  static m1(arg0, arg1) => "${arg0}添加了${arg1}";

  static m2(arg0) => "${arg0}离开了群组";

  static m3(arg0) => "${arg0}通过邀请链接加入群组";

  static m4(arg0, arg1) => "${arg0}移除了${arg1}";

  static m5(arg0, arg1) => "${arg0}置顶了${arg1}";

  static m6(count, arg0) => "${Intl.plural(count, one: '${arg0} 会话', other: '${arg0} 会话')}";

  static m7(arg0) => "${arg0}的圈子";

  static m8(arg0) => "Mixin ID: ${arg0}";

  static m9(arg0) => "删除会话：${arg0}";

  static m10(arg0) => "${arg0}创建了这个群组";

  static m11(arg0) => "确定删除${arg0}圈子吗？";

  static m12(arg0) => "错误 ${arg0}：请重新登录";

  static m13(arg0) => "错误 ${arg0}：请求数据不合法";

  static m14(arg0) => "错误 ${arg0}：区块链同步异常，请稍后重试";

  static m15(arg0) => "错误 ${arg0}：群组已满";

  static m16(arg0) => "错误 ${arg0}：余额不足";

  static m17(arg0, arg1) => "错误 ${arg0}：手续费不足。请确保钱包至少有 ${arg1} 当作手续费。";

  static m18(arg0, arg1, arg2) => "错误 ${arg0}：地址格式错误。请输入正确的 ${arg1} ${arg2} 的地址！";

  static m19(arg0) => "错误 ${arg0}：地址格式错误。";

  static m20(arg0) => "错误 ${arg0}：发送验证码太频繁，请稍后再试";

  static m21(arg0) => "错误 ${arg0}：紧急联系人不正确";

  static m22(arg0) => "错误 ${arg0}：无效密码格式";

  static m23(arg0) => "错误 ${arg0}：没有找到相应的信息";

  static m24(arg0) => "错误 ${arg0}: 已达到上限";

  static m25(arg0, arg1) => "错误 ${arg0}：请更新 Mixin(${arg1}) 至最新版。";

  static m26(arg0) => "错误 ${arg0}：手机号码不合法";

  static m27(arg0) => "错误 ${arg0}：发送短信失败";

  static m28(arg0) => "错误 ${arg0}：验证码已过期";

  static m29(arg0) => "错误 ${arg0}：验证码错误";

  static m30(arg0) => "错误 ${arg0}：PIN 不正确";

  static m31(count, arg0, arg1) => "${Intl.plural(count, one: '错误 ${arg0}：PIN 不正确。你还有${arg1}次机会，使用完需等待24小时后再次尝试。', other: '错误 ${arg0}：PIN 不正确。你还有${arg1}次机会，使用完需等待24小时后再次尝试。')}";

  static m32(arg0) => "错误 ${arg0}：验证失败";

  static m33(arg0) => "服务器出错，请稍后重试: ${arg0}";

  static m34(arg0) => "错误 ${arg0}：请求过于频繁";

  static m35(arg0) => "错误 ${arg0}：贴纸数已达上限";

  static m36(arg0) => "错误 ${arg0}：转账金额太小";

  static m37(arg0) => "错误 ${arg0}：提现金额太小";

  static m38(arg0) => "错误：${arg0}";

  static m39(arg0) => "错误：${arg0}";

  static m40(arg0) => "错误 ${arg0}：电话号码已经被占用。";

  static m41(arg0) => "ERROR ${arg0}: 提现备注格式不正确";

  static m42(arg0) => "发送消息至 ${arg0}";

  static m43(arg0) => "移除 ${arg0}";

  static m44(count) => "${Intl.plural(count, one: '%d 小时', other: '%d 小时')}";

  static m45(arg0) => "${arg0} 加入";

  static m46(arg0) => "您的账户将于 ${arg0} 被删除，如果您继续登录，删除您账户的请求将被取消。";

  static m47(arg0) => "我们将发送4位验证码到手机 ${arg0}, 请在下一个页面输入";

  static m48(arg0) => "请输入发送至以下号码的 4 位验证码： ${arg0}";

  static m49(arg0) => "我的 Mixin ID: ${arg0}";

  static m50(arg0, arg1) => "发现新版本 Mixin Messenger ${arg0}，当前版本为 ${arg1}。是否要下载最新的版本？";

  static m51(arg0) => "${arg0}现在是管理员";

  static m52(arg0) => "${arg0} 位群组成员";

  static m53(count, arg0) => "${Intl.plural(count, one: '${arg0}条置顶消息', other: '${arg0}条置顶消息')}";

  static m54(arg0) => "${arg0} 秒后重新发送验证码";

  static m55(count, arg0) => "${Intl.plural(count, one: '${arg0} 条相关的消息', other: '${arg0} 条相关的消息')}";

  static m56(arg0) => "无法打开文件：${arg0}";

  static m57(arg0) => "价值 ${arg0}";

  static m58(arg0) => "当时价值 ${arg0}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "addPeopleSearchHint" : MessageLookupByLibrary.simpleMessage("Mixin ID 或手机号"),
    ...
    "alertKeyContactContactMessage" : MessageLookupByLibrary.simpleMessage("分享了一个联系人"),
    "allChats" : MessageLookupByLibrary.simpleMessage("全部聊天"),
    "appCardShareDisallow" : MessageLookupByLibrary.simpleMessage("该链接已被设置为不允许分享"),
    ...
    "canNotRecognizeQrCode" : MessageLookupByLibrary.simpleMessage("无法识别二维码"),
    "cancel" : MessageLookupByLibrary.simpleMessage("取消"),
    "card" : MessageLookupByLibrary.simpleMessage("卡片"),
    "change" : MessageLookupByLibrary.simpleMessage("更改"),
    "chatAppReceptionTitle" : MessageLookupByLibrary.simpleMessage("点击按钮使用机器人"),
    ...
    "chatNotSupportUriOnPhone" : MessageLookupByLibrary.simpleMessage("不支持此链接，请在手机上查看。"),
    "chatNotSupportViewOnPhone" : MessageLookupByLibrary.simpleMessage("不支持此类型消息，请在手机上查看。"),
    "chatPinMessage" : m5,
    ...
    "clickToReloadQrcode" : MessageLookupByLibrary.simpleMessage("点击重新加载二维码"),
    ...
    "deleteChatDescription" : MessageLookupByLibrary.simpleMessage("删除会话只会删除此设备的聊天记录，不会影响其他设备。"),
    ...
    "editImageClearWarning" : MessageLookupByLibrary.simpleMessage("退出将会清除此次所有的改动。"),
    ...
    "errorAddressExists" : MessageLookupByLibrary.simpleMessage("地址不存在，请确保地址是否添加成功"),
    ...
    "errorBadData" : m13,
    "errorBlockchain" : m14,
    "errorConnectionTimeout" : MessageLookupByLibrary.simpleMessage("网络连接超时"),
    "errorFullGroup" : m15,
    ...
    "errorNetworkTaskFailed" : MessageLookupByLibrary.simpleMessage("网络连接失败。检查或切换网络，然后重试"),
    "errorNotFound" : m23,
    "errorNotSupportedAudioFormat" : MessageLookupByLibrary.simpleMessage("不支持的音频格式，请用其他app打开。"),
    ...
    "errorPinCheckTooManyRequest" : MessageLookupByLibrary.simpleMessage("你已经尝试了超过5次，请等待24小时后再次尝试。"),
    ...
    "errorTranscriptForward" : MessageLookupByLibrary.simpleMessage("请在所有附件下载完成之后再转发"),
    "errorUnableToOpenMedia" : MessageLookupByLibrary.simpleMessage("无法找到能打开该媒体的应用"),
    "errorUnknownWithCode" : m38,
    "errorUnknownWithMessage" : m39,
    "errorUsedPhone" : m40,
    "errorUserInvalidFormat" : MessageLookupByLibrary.simpleMessage("用户数据不合法"),
    ...
    "followUsOnFacebook" : MessageLookupByLibrary.simpleMessage("关注我们的 Facebook"),
    "followUsOnTwitter" : MessageLookupByLibrary.simpleMessage("关注我们的 Twitter"),
    ...
    "groupCantSend" : MessageLookupByLibrary.simpleMessage("您不能发送消息，因为您已经不再是此群组成员。"),
    ...
    "inviteInfo" : MessageLookupByLibrary.simpleMessage("Mixin 使用者可以使用此链接加入这个群组，请只跟您信任的人共享链接。"),
    ...
    "loadingTime" : MessageLookupByLibrary.simpleMessage("检测到系统时间异常，请校正后再继续使用"),
    "locateToChat" : MessageLookupByLibrary.simpleMessage("定位到聊天"),
    "location" : MessageLookupByLibrary.simpleMessage("位置"),
    "logIn" : MessageLookupByLibrary.simpleMessage("登录"),
    "loginAndAbortAccountDeletion" : MessageLookupByLibrary.simpleMessage("继续登录并放弃删除账户"),
    "loginByQrcode" : MessageLookupByLibrary.simpleMessage("通过二维码登录 Mixin Messenger"),
    "loginByQrcodeTips" : MessageLookupByLibrary.simpleMessage("打开手机上的 Mixin Messenger，扫描屏幕上的二维码，确认登录。"),
    ...
    "messageE2ee" : MessageLookupByLibrary.simpleMessage("此对话中的消息使用端对端加密。点击了解更多。"),
    "messageNotFound" : MessageLookupByLibrary.simpleMessage("找不到该消息"),
    "messageNotSupport" : MessageLookupByLibrary.simpleMessage("不支持此类型消息。请升级 Mixin 查看。"),
    "messagePreview" : MessageLookupByLibrary.simpleMessage("消息预览"),
    "messagePreviewDescription" : MessageLookupByLibrary.simpleMessage("预览新消息通知中的消息文本。"),
    "messages" : MessageLookupByLibrary.simpleMessage("消息"),
    "minimize" : MessageLookupByLibrary.simpleMessage("最小化"),
    "mixinMessengerDesktop" : MessageLookupByLibrary.simpleMessage("Mixin Messenger 桌面"),
    ...
    "notificationContent" : MessageLookupByLibrary.simpleMessage("不再遗漏好友的消息。"),
    "notificationPermissionManually" : MessageLookupByLibrary.simpleMessage("未允许通知，请到通知设置开启。"),
    ...
    "pickAConversation" : MessageLookupByLibrary.simpleMessage("选择一个对话，开始发送信息"),
    ...
    "removeChatFromCircle" : MessageLookupByLibrary.simpleMessage("从圈子里移除对话"),
    ...
    "scamWarning" : MessageLookupByLibrary.simpleMessage("警告：此账号被大量用户举报，请谨防网络诈骗，注意个人财产安全"),
    ...
    "sendWithoutCompression" : MessageLookupByLibrary.simpleMessage("发送原始文件"),
    "sendWithoutSound" : MessageLookupByLibrary.simpleMessage("静音发送"),
    "settingAuthSearchHint" : MessageLookupByLibrary.simpleMessage("Mixin ID, 昵称"),
    ...
    "storageAutoDownloadDescription" : MessageLookupByLibrary.simpleMessage("更改媒体的自动下载设置。"),
    ...
    "unpinAllMessagesConfirmation" : MessageLookupByLibrary.simpleMessage("确定取消置顶所有消息么？"),
    ...
    "webview2RuntimeInstallDescription" : MessageLookupByLibrary.simpleMessage("该设备暂未安装 WebView2 组件，请先下载并安装 WebView2 Runtime。"),
    "webviewRuntimeUnavailable" : MessageLookupByLibrary.simpleMessage("WebView2 组件不可用"),
    ...
    "youDeletedThisMessage" : MessageLookupByLibrary.simpleMessage("你撤回了一条消息")
  };
}
