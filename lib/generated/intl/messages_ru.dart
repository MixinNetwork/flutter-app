...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(arg0) => "${arg0} изменил настройки исчезающих сообщений.";

  static String m1(arg0) =>
      "Ожидание подключения ${arg0} к сети и установления зашифрованного сеанса.";

  static String m2(count, arg0) =>
      "${Intl.plural(count, one: 'Удалить ${arg0} сообщение?', other: 'Удалить ${arg0} сообщения?')}";
  ...
  static String m6(arg0, arg1) => "${arg0} удалил ${arg1}";

  static String m7(arg0, arg1) => "${arg0} закрепил ${arg1}";

  static String m8(count, arg0) =>
      "${Intl.plural(count, one: '${arg0} чат', other: '${arg0} чаты')}";

  static String m9(arg0) => "Круги пользователя ${arg0}";

  static String m10(arg0) => "Идентификатор Mixin: ${arg0}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addPeopleSearchHint": MessageLookupByLibrary.simpleMessage(
      "Mixin ID или номер телефона",
    ),
    "addSticker": MessageLookupByLibrary.simpleMessage("Добавить наклейку"),
    "addStickerFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось добавить стикер",
    ),
    "addStickers": MessageLookupByLibrary.simpleMessage("Добавить стикеры"),
    ...
    "contentVoice": MessageLookupByLibrary.simpleMessage("[Голосовой вызов]"),
    "continueText": MessageLookupByLibrary.simpleMessage("Продолжить"),
    "conversation": MessageLookupByLibrary.simpleMessage("Беседа"),
    ...
    "createCircle": MessageLookupByLibrary.simpleMessage("Новый круг"),
    ...
    "deleteCircle": MessageLookupByLibrary.simpleMessage("Удалить круг"),
    ...
    "editName": MessageLookupByLibrary.simpleMessage("Редактировать название"),
    ...
    "errorAuthentication": MessageLookupByLibrary.simpleMessage(
      "ОШИБКА 401: Войдите, чтобы продолжить",
    ),
    ...
    "errorTooManyStickers": MessageLookupByLibrary.simpleMessage(
      "ОШИБКА 20126: Слишком много наклеек",
    ),
    ...
    "fileError": MessageLookupByLibrary.simpleMessage("Ошибка файла"),
    "files": MessageLookupByLibrary.simpleMessage("Файлы"),
    "followSystem": MessageLookupByLibrary.simpleMessage("Следуйте системе"),
    "followUsOnFacebook": MessageLookupByLibrary.simpleMessage(
      "Следите за нами на Фейсбуке",
    ),
    "followUsOnX": MessageLookupByLibrary.simpleMessage("Следите за нами на X"),
    ...
    "noAudio": MessageLookupByLibrary.simpleMessage("НЕТ АУДИО"),
    "noCamera": MessageLookupByLibrary.simpleMessage("Нет камеры"),
    "noData": MessageLookupByLibrary.simpleMessage("Нет данных"),
    "noFiles": MessageLookupByLibrary.simpleMessage("ФАЙЛОВ НЕТ"),
    ...
    "recentChats": MessageLookupByLibrary.simpleMessage("ЧАТЫ"),
    "reedit": MessageLookupByLibrary.simpleMessage("Редактировать повторно"),
    "refresh": MessageLookupByLibrary.simpleMessage("Обновить"),
    "removeBot": MessageLookupByLibrary.simpleMessage("Удалить бота"),
    "removeChatFromCircle": MessageLookupByLibrary.simpleMessage(
      "Удалить чат из круга",
    ),
    "removeContact": MessageLookupByLibrary.simpleMessage("Удалить контакт"),
    "removeStickers": MessageLookupByLibrary.simpleMessage("Удалить наклейки"),
    ...
    "saveToCameraRoll": MessageLookupByLibrary.simpleMessage(
      "Сохранить в ленту камеры",
    ),
    "sayHi": MessageLookupByLibrary.simpleMessage("Скажи привет"),
    ...
    "searchContact": MessageLookupByLibrary.simpleMessage("Поиск контакта"),
    "searchConversation": MessageLookupByLibrary.simpleMessage("Поиск беседы"),
    ...
    "shareContact": MessageLookupByLibrary.simpleMessage(
      "Поделиться контактом",
    ),
    "shareError": MessageLookupByLibrary.simpleMessage("Поделитесь ошибкой."),
    ...
    "signWithQrcode": MessageLookupByLibrary.simpleMessage("Войти с QrCode"),
    ...
    "strangerHint": MessageLookupByLibrary.simpleMessage(
      "Этого отправителя нет в ваших контактах",
    ),
    ...
    "trace": MessageLookupByLibrary.simpleMessage("След"),
    "transactionHash": MessageLookupByLibrary.simpleMessage("Хэш транзакции"),
    ...
    "typeMessage": MessageLookupByLibrary.simpleMessage("Введите сообщение"),
    ...
    "valueNow": m52,
    "valueThen": m53,
    "verifyPin": MessageLookupByLibrary.simpleMessage("Подтвердить PIN-код"),
