...
TransferDataTranscriptMessage _$TransferDataTranscriptMessageFromJson(
  ...
  mediaStatus: const MediaStatusJsonConverter().fromJson(
    json['media_status'] as String?,
  ),
  ...
  mediaCreatedAt: _safeDateTimeFromJson(json['media_created_at'] as String?),
...
Map<String, dynamic> _$TransferDataTranscriptMessageToJson(
  ...
  'media_status': const MediaStatusJsonConverter().toJson(instance.mediaStatus),
