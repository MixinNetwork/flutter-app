...
class BrightnessThemeDataTween extends Tween<BrightnessThemeData> {
  BrightnessThemeDataTween({BrightnessThemeData begin, BrightnessThemeData end})
      : super(begin: begin, end: end);

  @override
  BrightnessThemeData lerp(double t) => BrightnessThemeData.lerp(begin, end, t);
}
