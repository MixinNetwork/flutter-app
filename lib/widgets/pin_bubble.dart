...
class _PinBubbleClipper extends CustomClipper<Path> {
  ...
  Path _rightNipPath(Size bubbleSize) {
    ...
    final path = Path()
      ..lineTo(0, 0)
      ..cubicTo(0, 0, size.width * 0.85, size.height / 3, size.width * 0.85,
          size.height / 3)
      ..cubicTo(size.width * 1.05, size.height * 0.41, size.width * 1.05,
          size.height * 0.59, size.width * 0.85, size.height * 0.67)
      ..cubicTo(
          size.width * 0.85, size.height * 0.67, 0, size.height, 0, size.height)
