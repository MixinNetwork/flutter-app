...
import 'pre_key_util.dart' as pre_key_util;
...
Future<SignalKeyRequest> generateKeys() async {
  ...
  final oneTimePreKeys = await pre_key_util.generatePreKeys();
  final signedPreKeyRecord =
      await pre_key_util.generateSignedPreKey(identityKeyPair, false);
